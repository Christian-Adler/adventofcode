...
/**
 * Cuboid
 * p0 and p7 could be the equal Vec3d - means a 1x1x1 Cuboid containing one cube
 * <pre>
 *  p2 ____________ p3
 *    /|          /|
 *   / |         / |
...
public class Cuboid {
  ...
  /**
   * @param input - e.g. x=10..12,y=10..12,z=10..12
   */
  ...
  public List<Cuboid> splitBy(Cuboid other) {
    ...
    // corners
    result.add(new Cuboid(getP0(), splitBy.getP0().add(-1, -1, -1))); // 01
    result.add(new Cuboid(getP1(), splitBy.getP1().add(1, -1, -1))); // 03
    result.add(new Cuboid(getP2(), splitBy.getP2().add(-1, 1, -1))); // 07
    result.add(new Cuboid(getP3(), splitBy.getP3().add(1, 1, -1))); // 09
    result.add(new Cuboid(getP4(), splitBy.getP4().add(-1, -1, 1))); // 19
    result.add(new Cuboid(getP5(), splitBy.getP5().add(1, -1, 1))); // 21
    result.add(new Cuboid(getP6(), splitBy.getP6().add(-1, 1, 1))); // 25
    result.add(new Cuboid(getP7(), splitBy.getP7().add(1, 1, 1))); // 27

    // centers
    result.add(new Cuboid(splitBy.getP0().withZ(getP0()), splitBy.getP3().add(0, 0, -1))); // 05
    result.add(new Cuboid(splitBy.getP4().withZ(getP4()), splitBy.getP7().add(0, 0, 1))); // 23
    result.add(new Cuboid(splitBy.getP0().withY(getP0()), splitBy.getP5().add(0, -1, 0))); // 11
    result.add(new Cuboid(splitBy.getP2().withY(getP2()), splitBy.getP7().add(0, 1, 0))); // 17
    result.add(new Cuboid(splitBy.getP2().withX(getP2()), splitBy.getP4().add(-1, 0, 0))); // 13
    result.add(new Cuboid(splitBy.getP3().withX(getP3()), splitBy.getP5().add(1, 0, 0))); // 15

    // edges
    result.add(new Cuboid(getP0().withX(splitBy.getP0()), splitBy.getP1().add(0, -1, -1))); // 02
    result.add(new Cuboid(getP4().withX(splitBy.getP4()), splitBy.getP5().add(0, -1, 1))); // 20
    result.add(new Cuboid(getP2().withX(splitBy.getP2()), splitBy.getP3().add(0, 1, -1))); // 08
    result.add(new Cuboid(getP6().withX(splitBy.getP6()), splitBy.getP7().add(0, 1, 1))); // 26

    result.add(new Cuboid(getP0().withY(splitBy.getP0()), splitBy.getP2().add(-1, 0, -1))); // 04
    result.add(new Cuboid(getP1().withY(splitBy.getP1()), splitBy.getP3().add(1, 0, -1))); // 06
    result.add(new Cuboid(getP4().withY(splitBy.getP4()), splitBy.getP6().add(-1, 0, 1))); // 22
    result.add(new Cuboid(getP5().withY(splitBy.getP5()), splitBy.getP7().add(1, 0, 1))); // 24

    result.add(new Cuboid(getP0().withZ(splitBy.getP0()), splitBy.getP4().add(-1, -1, 0))); // 10
    result.add(new Cuboid(getP1().withZ(splitBy.getP1()), splitBy.getP5().add(1, -1, 0))); // 12
    result.add(new Cuboid(getP2().withZ(splitBy.getP2()), splitBy.getP6().add(-1, 1, 0))); // 16
    result.add(new Cuboid(getP3().withZ(splitBy.getP3()), splitBy.getP7().add(1, 1, 0))); // 18
