...
public class Task {
    ...
    public void addLine(String input) {
        ...
        if (in.startsWith("Monkey")) {
            ...
            divisibleProduct *= actParsing.testValue;
...
//                    worryLevel = Math.floorDiv(worryLevel, 3); // Aufgabe 1

//                    while (worryLevel > divisibleProduct) // Aufgabe 2
//                        worryLevel -= divisibleProduct;
                    worryLevel = worryLevel % divisibleProduct;
