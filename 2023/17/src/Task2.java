...
public class Task2 {
  private static final int MAX_STEPS_PER_DIR = 10;
  private static final int MIN_STEPS_PER_DIR = 4;
  ...
  public void afterParse() throws IOException {
    ...
    while (!openList.isEmpty()) {
      ...
      if (workItem.pos.equals(end) && workItem.soFarStepsInDirection >= MIN_STEPS_PER_DIR) {
      ...
      // Drehbar?
      if (workItem.soFarStepsInDirection >= MIN_STEPS_PER_DIR) {
    ...
    out("Part 2", "min heat los", minHeatLos); //
